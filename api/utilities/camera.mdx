...
Internal method for additional camera configuration. Currently a placeholder for future enhancements.

### Camera View Methods

The following methods are placeholders for future camera view presets:

<ParamField path="orthoCamera()" type="function">
  Future: Switch to orthographic camera view.
</ParamField>

<ParamField path="perspectiveCamera()" type="function">
  Future: Switch to perspective camera view.
</ParamField>

<ParamField path="isometricCamera()" type="function">
  Future: Switch to isometric camera view.
</ParamField>
